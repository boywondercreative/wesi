...
<div class="my_meta_control">
    ...
    <a href="#" class="add docopy-person button"><?php _e('Add person');?></a>   
...
<div class="skinny">		
		...
		<div class="meta_inside clearfix">   
            ...
            <div class="slide_info"> 
                ...
                <label for="<?php $mb->the_name(); ?>">Enter position</label>
                <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
                </p>  
                
                <p>
                <?php $mb->the_field('email'); ?>
                <label for="<?php $mb->the_name(); ?>">Enter email</label>
                <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
                </p> 
                
                <p>
                <?php $mb->the_field('phone'); ?>
                <label for="<?php $mb->the_name(); ?>">Enter phone # </label>
                <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
                </p> 
