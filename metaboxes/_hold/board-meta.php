...
<div class="my_meta_control">
    ...
    <p class="instructions"><span>1)</span> Click the "Add Person" button.</p>
    <p class="instructions"><span>2)</span> Choose a using the "Upload Image" button.</p> 
    ...
    <a href="#" class="add docopy-person button"><?php _e('Add slide');?></a>   
    <a href="#" class="deleteall dodelete-person button"><?php _e('Remove All');?></a>
    </div>      
          
        <?php while($mb->have_fields_and_multi('person')): ?>
        <?php $mb->the_group_open(); ?>

<div class="skinny">
             
        <a href="#" class="dodelete icon close remove" title="<?php _e('Remove');?>">&#8722;</a>
        <h3 class="slide handle"><span class="count"><?php _e('Person #')?><?php echo ($mb->get_the_index() +1 );?></span></h3>
		...
		<div class="slide_info"> 
            ...
            <label for="<?php $mb->the_name(); ?>">Enter position on board (optional)</label>
            <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
            </p>  
            
            <p>
			<?php $mb->the_field('title'); ?>
            <label for="<?php $mb->the_name(); ?>">Enter title at day job</label>
            <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
            </p> 
			
            <p>
			<?php $mb->the_field('job'); ?>
            <label for="<?php $mb->the_name(); ?>">Enter day job </label>
            <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
            </p> 
            <p>
...
<div class="btn_grp"> 
<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-person button"><?php _e('Add Person');?></a></p>    
